...
public class BankService {
    /**
     * Содержит всех пользователей с привязанными к ним банковским счетами,
     ...
     * сначала ищем пользователя по паспорту с помощью метода {@link ru.job4j.bank.BankService#findByPassport(String)}} .
